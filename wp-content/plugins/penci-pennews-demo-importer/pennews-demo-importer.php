<?php
/**
 * Plugin Name: Penci PenNews Demo Importer
 ...
 * @version 5.0
 */
class Penci_PenNews_Demo_Importer {
	/**
	...
	public function __construct() {
		...
		$this->data = apply_filters( 'penci_demo_packages', array() );
	...
	public function menu() {
		...
		add_submenu_page(
			...
			esc_html__( 'Import Demo Data', 'pennews' ),
			esc_html__( 'Import Demo Data', 'pennews' ),
			'manage_options',
			'import-demo-content',
			array( $this, 'page' ) );
	...
	public function scripts( $hook ) {
		...
		wp_enqueue_style( 'penci-pennews-import', plugins_url( 'assets/css/penci-import.css', __FILE__ ) );
		wp_enqueue_script( 'penci-pennews-import', plugins_url( 'assets/js/penci-import.js', __FILE__ ), array( 'jquery' ), '1.0.0', true );
	}
	...
	private function select_demo_page() {
		...
		<div class="wrap penci-wraper-import">
...
if ( version_compare( phpversion(), '5.3.2', '<' ) ) {
	...
	add_action( 'init', function() {
		new Penci_PenNews_Demo_Importer();
	} );
}
