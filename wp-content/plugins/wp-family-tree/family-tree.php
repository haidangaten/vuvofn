			...
			<tr>
				...
				<td>
					<select name="gender" id="gender">
						...
						<option value="m" <?php if ($gender=="m" ) echo "selected=\" selected\""; ?>>Nam</option>
						<option value="f" <?php if ($gender=="f" ) echo "selected=\" selected\""; ?>>Nữ</option>
					</select></td>
			</tr>
			<tr>
				<td>Ngày sinh:</td>
				<td><input type="text" name="born" value="<?php echo wp_specialchars(get_post_meta($post->ID, 'born', true), true) ?>"
					 id="born" size="80" /></td>
			
			</tr>
			<tr>
				<td>Ngày mất:</td>
				<td><input type="text" name="died" value="<?php echo wp_specialchars(get_post_meta($post->ID, 'died', true), true) ?>"
					 id="died" size="80" /></td>
			</tr>
			<tr>
				<td>Mẹ:</td>
