...
$single_hide_img = ( penci_get_setting( 'penci_hide_single_featured_img' ) || $pcurrent_hide_img ) && 'standard' == get_post_format() ? true :  false;
$align_title     = 'penci-title-' . penci_get_setting( 'penci_single_align_post_title' );
$post_thumb_url  = penci_post_formats( 'penci-thumb-1920-auto' );
?>
...
<?php while ( have_posts() ) : the_post(); $pheader_show = penci_check_page_title_show(); ?>
	...
	<?php endif; ?>
<div class="penci-container">
	<div class="penci-container__content <?php echo esc_attr( ! $single_hide_img && $post_thumb_url ? '' : 'hide_featured_image' ); ?>">
