...
$post_thumb_url  = penci_post_formats( 'penci-thumb-1920-auto', false, true );
?>
<?php
...
<div class="penci-container">
	...
	<?php endif; ?>
	<div class="penci-container__content noloaddisqus <?php echo esc_attr( ! $single_hide_img && $post_thumb_url ? '' : 'hide_featured_image' ); ?>" data-url="<?php the_permalink() ?>" data-id="<?php the_ID(); ?>" data-title="<?php get_the_guid(); ?>">
