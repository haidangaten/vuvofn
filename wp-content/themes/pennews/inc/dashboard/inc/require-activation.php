				...
				<div class="penci-activate-wrap gt-tab-pane gt-is-active">
					<div class="penci-activate-envato-code">
						...
						<p class="penci-activate-desc">
							...
							<br>
							<?php esc_html_e( 'And please note that: With each license - you just can use for one website. If you want to use this theme for multiple sites, please buy more licenses for it. 2 licenses can use for 2 websites, 4 licenses can use for 4 websites, ...','pennews' ); ?>
						</p>
						<form id="penci-check-license" action="<?php echo admin_url( 'admin.php?page=pennews_active_theme' ); ?>">
							<div class="penci-activate-inputs">
								<input name="evato-code" class="penci-form-control evato-code" type="text" placeholder="<?php esc_html_e( 'Your envato code', 'pennews' ); ?>" value="">
								...
								<div class="penci-activate-err">
									...
									<span class="penci-err-invalid"><?php esc_html_e( 'Code is not valid','pennews' ); ?></span>
							...
							<div class="pennews-find-code">
								<a href="<?php echo  esc_url( 'https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-' ); ?>" target="_blank">
									<?php esc_html_e( 'Find your Envato code', 'pennews' ); ?>
								</a>
							</div>
						</form>
					</div>
