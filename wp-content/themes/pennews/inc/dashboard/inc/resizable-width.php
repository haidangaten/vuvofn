	...
	class Penci_Resizable_Width {
		...
		function update(){
			if ( ! empty($_POST) && isset( $_POST['_page'] ) && $_POST['_page'] === 'pennews_custom_width') {
				...
				if( isset( $_POST['penci_archive_columns_gap'] ) && $_POST['penci_archive_columns_gap'] ){
					set_theme_mod( 'penci_archive_columns_gap',  intval( $_POST['penci_archive_columns_gap'] ) );
				}

				if( isset( $_POST['penci_single_columns_gap'] ) && $_POST['penci_single_columns_gap'] ){
					set_theme_mod( 'penci_single_columns_gap', intval( $_POST['penci_single_columns_gap'] ) );
				}
