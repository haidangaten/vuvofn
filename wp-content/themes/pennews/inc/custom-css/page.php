...
function penci_customizer_page() {
	...
	if( $single_w3col  ){
		...
		if( $single_w3col_sbar1 && $single_w3col_sbar2 ){
			...
			$css .= '.page.two-sidebar .site-main .penci-container .widget-area-1 {width: ' . $single_w3col_sbar2 . '%;}';
			$css .= '.page.two-sidebar .site-main .penci-container .widget-area-2{ width: ' . $single_w3col_sbar1 . '%; }';
			$css .= '.page.two-sidebar .site-main .penci-container .penci-wide-content { width: ' . $single_w3col_main  . '%;max-width: 100%; }';
			$css .= '}';
		}
	}
	...
	if( $single_w2col ){
		...
		if( $single_w2col_main && $single_w2col_sbar1 ) {
			...
			$css .= '.page.sidebar-left .site-main .penci-wide-content,';
			$css .= '.page.sidebar-right .site-main .penci-wide-content{';
			$css .= 'width: ' . $single_w2col_main . '%;max-width: 100%;}';

			$css .= '.page.sidebar-left .site-main .widget-area,';
			$css .= '.page.sidebar-right .site-main .widget-area{';
			$css .= 'width: ' . $single_w2col_sbar1 . '%;max-width: 100%;}';
			$css .= '}';

			$css .= '@media screen and (max-width: 1240px) and (min-width: 960px){';
			$css .= '.page.sidebar-left .site-main .penci-wide-content,';
			$css .= '.page.sidebar-right .site-main .penci-container__content,';
			$css .= '.page.two-sidebar .site-main .penci-wide-content { margin-left:0; width: ' . $single_w2col_main . '%;}';
			$css .= '}';
		}
	}
	...
	if ( $single_columns_gap ) {
		...
		$css .= '@media screen and (min-width: 960px){';
		$css .= '.page.sidebar-left .site-main .penci-wide-content {padding-left: ' . esc_attr( $single_columns_gap ) . 'px;}';
		$css .= '.page.sidebar-right .site-main .penci-wide-content {padding-right: ' . esc_attr( $single_columns_gap ) . 'px;}';

		$css .= '}';
		$css .= '@media screen and (min-width: 1240px){';
		$css .= '.page.two-sidebar .site-main .penci-container .penci-wide-content{ padding-left: ' . esc_attr( $single_columns_gap ) . 'px; padding-right: ' . esc_attr( $single_columns_gap ) . 'px;}';
		$css .= '}';
	}
